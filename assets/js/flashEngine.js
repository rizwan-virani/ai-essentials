/* ============================================================================
   ai essentials  ::  flashEngine.js  —  Rapid Recall Flashcards
   ...
   - Cards live in lazy-loaded per-domain modules (assets/js/content/flashN.js),
     each populating AIESS.flash[N] with 100 cards { id, d, t, obj, front, back }.
   - Scheduling state persists to localStorage (aiess.flash.v1) keyed by card id,
...
(function () {
  ...
  function ver() { return window.AIESS_VER ? "?v=" + window.AIESS_VER : ""; }
